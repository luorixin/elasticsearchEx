package com.example.elasticsearchex.utils;
...
public class ElasticsearchUtil {
  ...
  public static boolean createIndex(String index){
    ...
    LOGGER.info("执行建立索引成功?"+indexResponse.isAcknowledged());
  ...
  public static boolean deleteIndex(String index){
    ...
    if (indexResponse.isAcknowledged()){
      ...
      LOGGER.info("delete index["+index+"] failed");
    }
   ...
   * @return
   */
  public static String addData(JSONObject jsonpObject, String index, String type, String id){
    IndexResponse response = client.prepareIndex(index, type, id).setSource(jsonpObject).get();
   ...
   * @return
   */
  public static String addData(JSONObject jsonpObject, String index, String type){
    return addData(jsonpObject, index, type, UUID.randomUUID().toString().replaceAll("-","").toUpperCase());
  }
   ...
   * @param id
   */
  public static void updateDataById(JSONObject jsonpObject, String index, String type, String id){
    UpdateRequest request = new UpdateRequest();
    request.index(index).type(type).id(id).doc(jsonpObject);
